...
export default function DrawClient({ id }: { id: string }) {
  const { draw, setDraw, loading } = useLuckyDraw(id, true);
  ...
  return <DrawScreen draw={draw} mode="owner" onItemDecremented={handleItemDecremented} />;
}
