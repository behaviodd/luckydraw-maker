      ...
      <div className="flex-1">
        ...
        {showProbability && probability !== undefined && (
          <div className="flex items-center gap-2 mt-2">
            <div className="flex-1 h-3 bg-bg-subtle overflow-hidden border-2 border-gum-black">
              <div className="h-full transition-all bg-gum-pink" style={{ width: `${Math.min(probability, 100)}%` }} />
            </div>
            <span className="text-xs font-mono font-bold min-w-[44px] text-right text-gum-pink">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-1">
          <button type="button"
            ...
            className="w-8 h-8 bg-bg-card flex items-center justify-center text-text-secondary hover:text-white transition-colors border-2 border-gum-black shadow-brutal-sm hover:bg-gum-pink">
        ...
        {isEditing && remaining !== undefined && (
          <div className="flex items-center gap-1">
            ...
            <button type="button"
              ...
              className="w-6 h-6 bg-bg-card flex items-center justify-center text-text-secondary hover:text-white transition-colors text-[10px] border-2 border-gum-black/50 hover:bg-gum-green">
